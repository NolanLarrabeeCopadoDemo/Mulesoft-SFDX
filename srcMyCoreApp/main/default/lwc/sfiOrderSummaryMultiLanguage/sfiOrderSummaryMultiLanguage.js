...
import { OMNIDEF } from './sfiOrderSummaryMultiLanguage_def.js';
import tmpl from './sfiOrderSummaryMultiLanguage.html';
import tmpl_nds from './sfiOrderSummaryMultiLanguage_nds.html';

/**
 *  IMPORTANT! Generated class DO NOT MODIFY
 */
export default class sfiOrderSummaryMultiLanguage extends OmniscriptHeader {
    @track jsonDef = {};
    @track resume = false;
    @api get inline() {
        return this._inline;
